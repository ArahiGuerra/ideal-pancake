...
document.getElementById('validateSymbol2').addEventListener('click', () => {
    ...
    if (answer === '-p') { // Compara con el símbolo correcto
...
truthValuesForm2.addEventListener('change', () => {
    ...
    // Mostrar el botón solo si ambos select tienen un valor válido
    if (case5 !== 'null' && case6 !== 'null') {
        validateButton.style.display = "block"; // Mostrar botón
    } else {
        validateButton.style.display = "none";  // Ocultar botón
    }
});
