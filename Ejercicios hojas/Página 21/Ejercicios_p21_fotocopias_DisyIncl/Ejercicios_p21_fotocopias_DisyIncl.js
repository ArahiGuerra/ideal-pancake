function verificarParteA() {
    const correctas = [false, true, true, false, true, false, true];
    let correctasUsuario = [
      ...
      document.getElementById('a7').checked
    ];
  ...
  function verificarParteB() {
    const respuestasCorrectas = ['verdadero', 'falso', 'verdadero', 'verdadero', 'falso'];
